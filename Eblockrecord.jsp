...
<div class="header">
<div class="button">
  <a href="Eblockpage.jsp">HOME</a>
  <a class="active" href="Eblockrecord.jsp">RECORDS</a>
                    ...
                    <h1 align="center">E-BLOCK PAGE</h1>
                     <table  style="border:black;color:black; font-family: Arial, Helvetica, sans-serif; font-size:10px; font-weight:bold;" border="5" cellpadding="5" cellspacing="1" >
                            ...
                            {	
                                ...
                                ResultSet rs1=stmt1.executeQuery("call EBlockreq_display('"+strDate+"')");
                                while(rs1.next())
                                {
                            %>
                                <tr>
