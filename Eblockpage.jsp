...
<div class="button">
  ...
  <a href="Eblockrecord.jsp">RECORDS</a>
  <a href="login.jsp">LOGOUT</a>
</div>
</div>
                    <div class="title">Welcome:<%out.println(appemails);%></div>
                       <h1 align="center">E-BLOCK PAGE</h1>
                    <section>
                        <article>
                            ...
                            %>
                               ...
                               <td><button type="button" class="button1" value="approve" onclick="location.href='ServletApprove1?ID=<%=rs1.getString("roll_no")%> '" style="width:120px;
                                     height:40px; 
                                     border:none; 
                                      margin:0px 25px;
                                     border-radius:6px; 
                                    ...
                                    <button type="button" class="button2" value="reject" onclick="location.href='ServletReject1?ID=<%=rs1.getString("roll_no") %>'" style="width:120px;
                                     height:40px; 
                                     border:none; 
                                      margin:0px 16px;
                                     border-radius:6px; 
        	...
        	try
         	{
        		...
        		Statement stmt1=conn.createStatement();
                ResultSet rs1=stmt1.executeQuery("select * from student_request where EBlock_status='"+approved+"' and HOD_status='"+approved+"' and dates='"+strDate+"'");
        		while(rs1.next())
        		{
        			count=rs1.getRow();
        		}
